...
SUB_CATEGORY_MAPPING={'Restaurants':['Full-Service Restaurants','Casino Hotels','Limited-Service Restaurants'],
                      ...
                      'Sports and Exercise':['Motorcycle, Bicycle, and Parts Manufacturing','Sports and Recreation Instruction','Fitness and Recreational Sports Centers','Golf Courses and Country Clubs','Racetracks',],
                      'Healthcare':['General Medical and Surgical Hospitals','Offices of Other Health Practitioners', 'Offices of Mental Health Practitioners (except Physicians)',
                                  ...
                                  'Offices of Dentists','Specialty (except Psychiatric and Substance Abuse) Hospitals','Medical and Diagnostic Laboratories','Nursing Care Facilities (Skilled Nursing Facilities)',
                                  'Other Ambulatory Health Care Services'],
                      'Social Support':['Psychiatric and Substance Abuse Hospitals','Other Information Services','Child Day Care Services',
...
sub_categories_to_pretty_names={'Restaurants':{'Fast Food':['Limited-Service Restaurants'],
                              ...
                              'Sports and Exercise':{'Sports Complex':['Promoters of Performing Arts, Sports, and Similar Events with Facilities'],
                                ...
                                'Work':{'Work':['Other Building Finishing Contractors','Services to Buildings and Dwellings',
                                ...
                                'Personal Services':{'Beauty Salon':['Beauty Salons'],
                                                     ...
                                                     'Event Planner':['Other Personal Services','All Other Consumer Goods Rental'],
                                ...
                                'Discretionary Retail':{'Mall':['Malls'],
                                                        ...
                                                        'Electronics Store':['Electronics Stores','Wired and Wireless Telecommunications Carriers','Wireless Telecommunications Carriers (except Satellite)'],
                                                        ...
                                                        'Car Parts Store':['Automotive Parts and Accessories Stores','Tire Dealers'],
                                ...
                                'Financial, Legal, Real Estate and Insurance Services':{'Real Estate Agents':['Offices of Real Estate Agents and Brokers','Residential Property Managers'],
                                                            ...
                                                            'Accountants':['Tax Preparation Services','Other Accounting Services','Accounting, Tax Preparation, Bookkeeping, and Payroll Services']},
                                'Healthcare':{'Physical Therapist':['Offices of Physical, Occupational and Speech Therapists, and Audiologists'],
                                              'Kidney Dialysis Center':['Kidney Dialysis Centers'],'Medical and Diagnostic Laboratories':['Medical and Diagnostic Laboratories','Medical Laboratories'],
                                              ...
                                              'Urgent Care':['Outpatient Care Centers','Freestanding Ambulatory Surgical and Emergency Centers','Urgent Care','Urgent Care,Walk-in Clinic'],
                                              'Psychiatric and Substance Abuse Hospital':['Psychiatric and Substance Abuse Hospitals','Addiction Treatment'],
                                              'Skilled Nursing Facility':['Nursing Care Facilities (Skilled Nursing Facilities)'],
                                ...
                                'Social Support':{'Home Health Care':['Home Health Care Services'],
                                                  ...
                                                  'Assisted Living Facilities for the Elderly':['Nursing and Residential Care Facilities','Assisted Living Facilities for the Elderly'],
